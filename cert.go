...
func Decrypt (user User, C Cipher1, params Params) () {
...
func ReDecrypt (user User, C Cipher1, D Cipher2, rekey ReKey, params Params, L floatToint.Length) () {
	var a2, b2 float64
